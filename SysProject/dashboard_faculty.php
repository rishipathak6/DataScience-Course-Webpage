        ...
        <div class="container">
          <div class="row align-items-center h-100">
            ...
            <div class="col-lg-6">
              ...
              <p class="lead mt-5 mb-8">Dashboard that allows you to post advertisement, notices, assignments, design and edit the course registration form.</p>
             
            </div>

            <div class="col-lg-5 ml-auto d-none d-lg-block">
              <img src="assets/img/faculty.jpg" alt="img">
            </div>
      ...
      <section class="section bg-gray overflow-hidden" id="advertisement" >
        ...
        <div class="container">
			<div class="row gap-y">
				...
				<div class="col-12 col-lg-6">
				  <div class="card text-white justify-content-end bg-img h-400" style="background-image: url(assets/img/uploadAssignment.jpg); " data-scrim-bottom="5">
					  <a href="#">
					<div class="card-body flex-grow-0">
             <a href="upload_assignment.php"><h3 class="card-title fw-200 text-center">Upload Assignments</h3></a>				 
					</div>
					  </a>
				  </div>
				</div>
