    ...
    <main class="main-content">
      ...
      <section class="section bg-gray overflow-hidden" id="list" >
		  <div class="section-header fw-500">
		  		<h2 class="display-4 fw-400">Top Registered Applicants List</h2>
		  </div>
		  <div class="row gap-y mx-13">
            ...
            <div>
                  <a class="btn btn-sm btn-round btn-primary ml-lg-4 mr-2" href="enroll_as_stud.php">Register Students</a>
            </div>
