<?php
     ...
     $val = 1;
      ...
      if($data['value'] == 0){
        ...
        echo '<script language="javascript">alert("Registration Opened"); window.location.href = "dashboard_staff.php"</script>';
      }else{
        echo '<script language="javascript">alert("Registration Already Opened"); window.location.href = "dashboard_staff.php"</script>';
      }
?>